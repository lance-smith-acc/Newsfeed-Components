...
function createArticle(data) {
  ...
  articleShell.appendChild(firstParagraph);
  articleShell.appendChild(secondParagraph);
  articleShell.appendChild(thirdParagraph);
  articleShell.appendChild(expandButton);
